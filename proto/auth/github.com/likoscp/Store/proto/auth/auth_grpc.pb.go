...
const (
	...
	UserService_AuthenticateUser_FullMethodName = "/auth.UserService/AuthenticateUser"
...
type UserServiceClient interface {
	...
	AuthenticateUser(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*AuthResponse, error)
...
func (c *userServiceClient) AuthenticateUser(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*AuthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthResponse)
...
type UserServiceServer interface {
	...
	AuthenticateUser(context.Context, *LoginRequest) (*AuthResponse, error)
...
func (UnimplementedUserServiceServer) AuthenticateUser(context.Context, *LoginRequest) (*AuthResponse, error) {
...
func _UserService_AuthenticateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).AuthenticateUser(ctx, req.(*LoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}
