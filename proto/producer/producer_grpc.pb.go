...
const (
	ProducerService_PublishOrderCreated_FullMethodName = "/proto.ProducerService/PublishOrderCreated"
)
...
type ProducerServiceClient interface {
	PublishOrderCreated(ctx context.Context, in *OrderCreated, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *producerServiceClient) PublishOrderCreated(ctx context.Context, in *OrderCreated, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, ProducerService_PublishOrderCreated_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProducerServiceServer interface {
	PublishOrderCreated(context.Context, *OrderCreated) (*Empty, error)
...
func (UnimplementedProducerServiceServer) PublishOrderCreated(context.Context, *OrderCreated) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PublishOrderCreated not implemented")
}
...
func _ProducerService_PublishOrderCreated_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OrderCreated)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProducerServiceServer).PublishOrderCreated(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProducerService_PublishOrderCreated_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProducerServiceServer).PublishOrderCreated(ctx, req.(*OrderCreated))
	}
...
var ProducerService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.ProducerService",
	HandlerType: (*ProducerServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "PublishOrderCreated",
			Handler:    _ProducerService_PublishOrderCreated_Handler,
		},
	},
