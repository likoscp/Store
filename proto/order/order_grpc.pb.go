...
const (
	...
	OrderService_PayOrder_FullMethodName     = "/proto.OrderService/PayOrder"
)
...
func (UnimplementedOrderServiceServer) UpdateOrder(context.Context, *UpdateOrderRequest) (*Empty, error) {
